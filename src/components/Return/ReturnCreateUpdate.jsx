...
import {CreatePurchaseRequest} from "../../APIRequest/PurchaseAPIRequest";
...
const ReturnCreateUpdate = () => {
    ...
    const CreateNewReturn=async () => {
        // Apply Validation
        let SupplierID = ReturnFormValue.CustomerID;
        let VatTax = ReturnFormValue.VatTax;
        let GrandTotal = ReturnFormValue.GrandTotal;
