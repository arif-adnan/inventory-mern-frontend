...
const MasterLayout = (props) => {
    ...
    // if isSidebarAccordionActive then corresponding submenu will be open by default when the page loads.
    const isSidebarAccordionActive = () => {
        ...
        return urlList.findIndex((items) =>
            items.includes(window.location.pathname) //returns the index of the first item in the urlList array that includes the current URL path
        );
    };
